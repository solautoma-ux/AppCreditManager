-- MIGRATION: 150_fix_rpc_column_mapping.sql
-- Description: Fixes the column name mismatch in registrar_pago_completo.
-- The table 'pagos' uses 'registrado_por_id', but the function was trying to insert into 'registrado_por'.
...
BEGIN
    ...
    -- 4. Register payment (FIX: Use registrado_por_id)
